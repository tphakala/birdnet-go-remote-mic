...
// example TempCelsius off Raspberry Pi hardware, or CPUPercent on a request
// with no recent previous reading to diff against). Empty strings likewise mean "unknown".
