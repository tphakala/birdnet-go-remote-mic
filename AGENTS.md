...
(the same data plus remote-mic's own LICENSE), which the web UI's About page
loads. Regenerate and commit both with any change that alters the linked
modules; the Licenses workflow does this itself on Dependabot pull requests.
